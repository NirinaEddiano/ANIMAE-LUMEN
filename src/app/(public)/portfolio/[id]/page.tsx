...
export default function ProjectPage() {
  ...
  return (
    ...
    <section className="pt-32 pb-16 px-6 lg:px-12">
              ...
              <div key={p.id} className="w-[240px] shrink-0 snap-start flex flex-col space-y-4 group">
                <Link href={`/portfolio/${p.id}`}>
                  <div className="overflow-hidden aspect-[3/4] bg-neutral-100 shadow-sm">
                    <img src={p.images[0]} alt={p.title_fr} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                  </div>
                </Link>
                <div className="space-y-1">
                  <h4 className="font-serif text-lg text-neutral-900">{p.title_fr}</h4>
      ...
      {/* SECTION : INTEGRATION INSTAGRAM (Statique) */}
